...
allowing somebody to distribute a Bitcoin-Qt.app or zurcoin-qt-setup.exe with a valid
...
that the zurcoin-qt.exe file inside the installer had not been tampered with.
