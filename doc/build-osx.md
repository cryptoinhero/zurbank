...
Bitcoin Core is now available at `./src/zurcoind`

Before running, it's recommended you create an RPC configuration file.

    echo -e "rpcuser=zurcoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Bitcoin/zurcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Bitcoin/zurcoin.conf"
