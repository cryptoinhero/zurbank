Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://zurcoin.org/bin/zurcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update zurcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow zurcoin-tx to create v2 transactions (btcdrak)
