Download URL: https://sourceforge.net/projects/zurcoin/files/Bitcoin/zurcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ZUR fee schedule (users still pay 0.01 ZUR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #zurcoin00 - #zurcoin99
