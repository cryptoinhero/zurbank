Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/zurcoin/files/Bitcoin/zurcoin-0.7.0/

We recommend that everybody running prior versions of zurcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/zurcoin/zurcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/zurcoin/zurcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the zurcoin-qt package:
  sudo apt-get install zurcoin-qt
...
Core zurcoin handling and blockchain database
...
* Ensure a changed zurcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for zurcoin-qt.exe
* (Windows only): add meta-data to zurcoin-qt.exe (e.g. description)
...
* Bash programmable completion for zurcoind(1)
