Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://zurcoin.org/bin/zurcoin-core-0.11.0/>
...
defaults to 0.00001. This will cause transactions with fewer ZUR/kB fee to be
...
related to the blockchain in the zurcoin system: the raw blocks as received over 
...
For an example script see [zurcoin-submittx](https://github.com/laanwj/zurcoin-submittx).
...
- #5334 `cf87536` libzurcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new zurcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add zurcoin logo to about screen
...
- #5809 `46bfbe7` Add zurcoin-cli man page
...
- #5849 `41259ca` contrib/init/zurcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for zurcoin-tx)
