...
enum MPRPCErrorCode
{
    ...
    MP_TX_IS_NOT_OMNI_PROTOCOL    = -3336,  // No Zus Layer Protocol transaction.
};
...
inline std::string error_str(int ec) {
  ...
  switch (ec)
  {
      ...
      case MP_INPUT_NOT_IN_RANGE:
          ec_str = "Input value supplied larger than supported in Zus Layer Protocol";
          break;
      ...
      case PKT_ERROR_TRADEOFFER -47:
          ec_str = "Property for sale must be ZUS or TZUS";
          break;
      ...
      case PKT_ERROR_METADEX -35:
          ec_str = "One side of the trade must be ZUS or TZUS";
          break;
