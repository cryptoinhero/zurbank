...
BOOST_FIXTURE_TEST_SUITE(zurbank_alert_tests, BasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(alert_positive_authorization)
{
    ...
    BOOST_CHECK(CheckAlertAuthorization("1883ZMsRJfzKNozUBJZURxQ7EaiNioNDWz"));  // Zathras <zathras@omni.foundation>
