...
$SRCDIR/zurbank-cli --regtest sendtoaddress $ADDR 7 >$NUL
$SRCDIR/zurbank-cli --regtest sendtoaddress $ADDR 8 >$NUL
...
BLOCK=$($SRCDIR/zurbank-cli --regtest getblockcount)
BLOCKHASH=$($SRCDIR/zurbank-cli --regtest getblockhash $(($BLOCK)))
$SRCDIR/zurbank-cli --regtest invalidateblock $BLOCKHASH >$NUL
PREVBLOCK=$($SRCDIR/zurbank-cli --regtest getblockcount)
$SRCDIR/zurbank-cli --regtest clearmempool >$NUL
$SRCDIR/zurbank-cli --regtest generate 1 >$NUL
NEWBLOCK=$($SRCDIR/zurbank-cli --regtest getblockcount)
NEWBLOCKHASH=$($SRCDIR/zurbank-cli --regtest getblockhash $(($BLOCK)))
