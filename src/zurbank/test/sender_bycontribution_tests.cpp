#include "zurbank/test/utils_tx.h"
...
BOOST_FIXTURE_TEST_SUITE(zurbank_sender_bycontribution_tests, BasicTestingSetup)
 ...
 *
 * Note: it reflects the behavior of ZURBank, but this edge case is not specified.
 */
