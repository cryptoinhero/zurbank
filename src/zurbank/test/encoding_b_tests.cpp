...
BOOST_FIXTURE_TEST_SUITE(zurbank_encoding_b_tests, BasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(class_b_empty)
{
    ...
    BOOST_CHECK(ZurBank_Encode_ClassB(strSeed, pubKey, vchPayload, vTxOuts));
    ...
    BOOST_CHECK_EQUAL(CBitcoinAddress(dest).ToString(), "UrpY6GsjF5WK33TzeiS8mQCPxzMdvbizp6");
}
