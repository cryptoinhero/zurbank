 ...
 */
bool ZurBank_Encode_ClassB(const std::string& senderAddress, const CPubKey& redeemingPubKey,
 ...
 */
bool ZurBank_Encode_ClassC(const std::vector<unsigned char>& vchPayload,
