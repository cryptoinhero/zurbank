...
// seller-address, offer_block, amount, property, desired ZUR , property_desired, fee, blocktimelimit
...
static int input_mp_offers_string(const std::string& s)
{
    ...
    if (OMNI_PROPERTY_ZUR != prop_desired) return -1;
