#ifndef ZURBANK_CREATEPAYLOAD_H
#define ZURBANK_CREATEPAYLOAD_H
...
std::vector<unsigned char> CreatePayload_ZurBankAlert(uint16_t alertType, uint32_t expiryValue, const std::string& alertMessage);
