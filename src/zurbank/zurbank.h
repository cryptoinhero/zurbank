#ifndef ZURBANK_ZURBANK_H
#define ZURBANK_ZURBANK_H
...
// Zus Layer Transaction (Packet) Version
...
enum TransactionType {
  ...
  ZURBANK_MESSAGE_TYPE_DEACTIVATION  = 65533,
  ZURBANK_MESSAGE_TYPE_ACTIVATION    = 65534,
  ZURBANK_MESSAGE_TYPE_ALERT         = 65535
};
