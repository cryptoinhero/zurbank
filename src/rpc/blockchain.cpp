...
UniValue getblockchaininfo(const UniValue& params, bool fHelp)
{
    ...
    softforks.push_back(SoftForkDesc("bip34", 112, tip, consensusParams));
    softforks.push_back(SoftForkDesc("bip66", 113, tip, consensusParams));
    softforks.push_back(SoftForkDesc("bip65", 114, tip, consensusParams));
