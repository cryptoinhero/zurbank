...
{
    BOOST_CHECK(TestSplitHost("www.zurcoin.org", "www.zurcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.zurcoin.org]", "www.zurcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.zurcoin.org:80", "www.zurcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.zurcoin.org]:80", "www.zurcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:18071", "127.0.0.1", 18071));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:18071", "127.0.0.1", 18071));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:18071", "::ffff:127.0.0.1", 18071));
    BOOST_CHECK(TestSplitHost("[::]:18071", "::", 18071));
    BOOST_CHECK(TestSplitHost("::18071", "::18071", -1));
    BOOST_CHECK(TestSplitHost(":18071", "", 18071));
    BOOST_CHECK(TestSplitHost("[]:18071", "", 18071));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:18071", "127.0.0.1:18071"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:18071", "[::]:18071"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
