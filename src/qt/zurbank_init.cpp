...
static bool getDisclaimerDialogResult()
{
    ...
    "The protocol and transaction processing rules for the Zus Layer are still under "
    ...
    "own risk. Neither the Zus Foundation nor the ZURBank developers assumes "
    ...
    "EXPERIMENTAL. Your wallet data, zurcoins and Zus Layer tokens may be lost, "
    ...
    "PLEASE DO NOT use wallet(s) with significant amounts of zurcoins or Zus Layer "
...
static bool showDisclaimer()
{
    ...
    return settings.value("ZurBank/fShowDisclaimer", true).toBool();
}
...
bool AskUserToAcknowledgeRisks()
{
    ...
    settings.setValue("ZurBank/fShowDisclaimer", !fAccepted);
