...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send Zus Layer and Zurcoin transactions"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zurcoin: URIs)"));
    ...
    **/
    ...
    openAction->setStatusTip(tr("Open a zurcoin: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible ZURBank command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zurcoin network", "", count));
}
...
{
    QString strTitle = tr("ZURBank"); // default title
...
void BitcoinGUI::setOmniPendingStatus(bool pending)
{
    if (!pending) {
        ...
        labelOmniPendingIcon->setPixmap(QIcon(":/icons/zus_hourglass").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
