...
###   This script attempts to download the signature file SHA256SUMS.asc from zurcoin.org
...
WORKINGDIR="/tmp/zurcoin"
TMPFILE="hashes.tmp"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://zurcoin.org/bin/"
VERSIONPREFIX="zurcoin-core-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'zurcoin-',
