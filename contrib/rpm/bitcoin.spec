...
#selinux
Source30:	https://raw.githubusercontent.com/zurcoin/zurcoin/v%{version}/contrib/rpm/zurcoin.te
# Source31 - what about zurcoin-tx and bench_zurcoin ???
Source31:	https://raw.githubusercontent.com/zurcoin/zurcoin/v%{version}/contrib/rpm/zurcoin.fc
Source32:	https://raw.githubusercontent.com/zurcoin/zurcoin/v%{version}/contrib/rpm/zurcoin.if
...
issuing of zurcoins is carried out collectively by the network.
...
%description libs
This package provides the zurcoinconsensus shared libraries. These libraries
...
zurcoinconsensus shared library. If you are developing or compiling software
...
the bench_zurcoin utility can be used to perform some benchmarks.
...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/zurcoin.ico %{buildroot}%{_datadir}/pixmaps/zurcoin.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/zurcoin.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/zurcoin16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/zurcoin32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/zurcoin64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/zurcoin128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/zurcoin256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/zurcoin256.png %{buildroot}%{_datadir}/pixmaps/zurcoin16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/zurcoin256.png %{buildroot}%{_datadir}/pixmaps/zurcoin32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/zurcoin256.png %{buildroot}%{_datadir}/pixmaps/zurcoin64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/zurcoin256.png %{buildroot}%{_datadir}/pixmaps/zurcoin128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/zurcoin256.png %{buildroot}%{_datadir}/pixmaps/zurcoin256.xpm
...
%{_sbindir}/semanage port -a -t zurcoin_port_t -p tcp 8372
%{_sbindir}/semanage port -a -t zurcoin_port_t -p tcp 18071
%{_sbindir}/semanage port -a -t zurcoin_port_t -p tcp 18372
%{_sbindir}/semanage port -a -t zurcoin_port_t -p tcp 21973
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 8372
	%{_sbindir}/semanage port -d -p tcp 18071
...
%attr(0755,root,root) %{_bindir}/bench_zurcoin
